...
class ClassicInterface(QMainWindow):
    ...
    def initUI(self):
        ...
        id_layout.addRow("Subject ID:", self.climber_id_input); id_layout.addRow("Action ID:", self.route_id_input)
    ...
    def _create_label_ui(self, label_data):
        ...
        numeric_checkbox = QCheckBox("Numeric (Zero Padding)", self); numeric_checkbox.setChecked(label_data.is_numeric)
